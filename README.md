...
1. **[profile-extraction](skills/profile-extraction/SKILL.md)** — parses your LinkedIn PDF, existing CV, LinkedIn URL, or pasted text into structured profile data
2. **[job-analysis](skills/job-analysis/SKILL.md)** — extracts requirements, ATS keywords, and priority ratings from any job description
